 ...
 */
export function aat_layout_feature_type_get_selector_infos(face: face_t, feature_type: aat_layout_feature_type_t, start_offset: number): [ /* returnType */ number, /* selectors */ aat_layout_feature_selector_info_t[], /* default_index */ number ]
/**
 ...
 */
export function buffer_serialize(buffer: buffer_t, start: number, end: number, font: font_t | null, format: buffer_serialize_format_t, flags: buffer_serialize_flags_t): [ /* returnType */ number, /* buf */ Uint8Array, /* buf_consumed */ number ]
/**
 ...
 * @returns The number of serialized items.
 */
export function buffer_serialize_unicode(buffer: buffer_t, start: number, end: number, format: buffer_serialize_format_t, flags: buffer_serialize_flags_t): [ /* returnType */ number, /* buf */ Uint8Array, /* buf_consumed */ number ]
/**
 ...
 */
export function color_line_get_color_stops(color_line: color_line_t, start: number): [ /* returnType */ number, /* color_stops */ color_stop_t[] ]
/**
 ...
 * @param to_y Y component of target point
 */
export function draw_line_to(dfuncs: draw_funcs_t, draw_data: any | null, st: draw_state_t, to_x: number, to_y: number): void
/**
 ...
 * @param to_y Y component of target point
 */
export function draw_move_to(dfuncs: draw_funcs_t, draw_data: any | null, st: draw_state_t, to_x: number, to_y: number): void
/**
 ...
 * @param to_y Y component of target point
 */
export function draw_quadratic_to(dfuncs: draw_funcs_t, draw_data: any | null, st: draw_state_t, control_x: number, control_y: number, to_x: number, to_y: number): void
/**
 ...
 */
export function font_draw_glyph(font: font_t, glyph: codepoint_t, dfuncs: draw_funcs_t, draw_data: any | null): void
/**
 ...
 * @param draw_data User data to pass to draw callbacks
 */
export function font_get_glyph_shape(font: font_t, glyph: codepoint_t, dfuncs: draw_funcs_t, draw_data: any | null): void
/**
 * Fetches the advance for a glyph ID in the specified font,
 ...
 */
export function font_paint_glyph(font: font_t, glyph: codepoint_t, pfuncs: paint_funcs_t, paint_data: any | null, palette_index: number, foreground: color_t): void
/**
 ...
 */
export function font_set_funcs_data(font: font_t, font_data: any | null): void
/**
 ...
 */
export function map_next(map: map_t, idx: number): [ /* returnType */ bool_t, /* idx */ number, /* key */ codepoint_t, /* value */ codepoint_t ]
/**
 ...
 * @param metrics_tag tag of metrics value you like to fetch.
 */
export function ot_metrics_get_position_with_fallback(font: font_t, metrics_tag: ot_metrics_tag_t): /* position */ position_t
/**
 ...
 */
export function ot_tags_to_script_and_language(script_tag: tag_t, language_tag: tag_t): [ /* script */ script_t, /* language */ language_t ]
/**
 ...
 */
export function paint_custom_palette_color(funcs: paint_funcs_t, paint_data: any | null, color_index: number): [ /* returnType */ bool_t, /* color */ color_t ]
/**
 ...
 */
export function paint_image(funcs: paint_funcs_t, paint_data: any | null, image: blob_t, width: number, height: number, format: tag_t, slant: number, extents: glyph_extents_t | null): void
/**
 ...
 */
export function paint_linear_gradient(funcs: paint_funcs_t, paint_data: any | null, color_line: color_line_t, x0: number, y0: number, x1: number, y1: number, x2: number, y2: number): void
/**
 * Perform a "pop-clip" paint operation.
 * @param funcs paint functions
 * @param paint_data associated data passed by the caller
 */
export function paint_pop_clip(funcs: paint_funcs_t, paint_data: any | null): void
/**
 ...
 */
export function paint_pop_group(funcs: paint_funcs_t, paint_data: any | null, mode: paint_composite_mode_t): void
/**
 * Perform a "pop-transform" paint operation.
 * @param funcs paint functions
 * @param paint_data associated data passed by the caller
 */
export function paint_pop_transform(funcs: paint_funcs_t, paint_data: any | null): void
/**
 ...
 * @param font the font
 */
export function paint_push_clip_glyph(funcs: paint_funcs_t, paint_data: any | null, glyph: codepoint_t, font: font_t): void
/**
 ...
 */
export function paint_push_clip_rectangle(funcs: paint_funcs_t, paint_data: any | null, xmin: number, ymin: number, xmax: number, ymax: number): void
/**
 * Perform a "push-group" paint operation.
 * @param funcs paint functions
 * @param paint_data associated data passed by the caller
 */
export function paint_push_group(funcs: paint_funcs_t, paint_data: any | null): void
/**
 ...
 */
export function paint_push_transform(funcs: paint_funcs_t, paint_data: any | null, xx: number, yx: number, xy: number, yy: number, dx: number, dy: number): void
/**
 ...
 */
export function paint_radial_gradient(funcs: paint_funcs_t, paint_data: any | null, color_line: color_line_t, x0: number, y0: number, r0: number, x1: number, y1: number, r1: number): void
/**
 ...
 */
export function paint_sweep_gradient(funcs: paint_funcs_t, paint_data: any | null, color_line: color_line_t, x0: number, y0: number, start_angle: number, end_angle: number): void
/**
 ...
 */
export function shape_justify(font: font_t, buffer: buffer_t, features: feature_t[] | null, shaper_list: string[] | null, min_target_advance: number, max_target_advance: number, advance: number): [ /* returnType */ bool_t, /* advance */ number, /* var_tag */ tag_t, /* var_value */ number ]
/**
...
export interface aat_layout_feature_selector_info_t {
...
export interface font_extents_t {
...
export interface glyph_extents_t {
...
export interface glyph_position_t {
...
export interface ot_color_layer_t {
...
export interface ot_math_glyph_part_t {
...
export interface ot_math_glyph_variant_t {
...
export interface ot_math_kern_entry_t {
...
export interface ot_name_entry_t {
...
export interface ot_var_axis_info_t {
...
export interface ot_var_axis_t {
...
export interface paint_funcs_t {
}
...
export interface segment_properties_t {
...
export interface unicode_funcs_t {
}
...
export interface user_data_key_t {
}
