...
![version](https://img.shields.io/npm/v/@gtile/gjs)
![downloads/week](https://img.shields.io/npm/dw/@gtile/gjs)

GJS TypeScript type definitions for Gjs using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v3.2.3.
...
```ts
import Gjs from '@gtile/gjs';
```

Or if you prefer CommonJS, you can also use this:
```ts
const Gjs = require('@gtile/gjs');
```
...
For this you need to include the `@gtile/gjs` or `@gtile/gjs/ambient` in your `tsconfig` or entry point Typescript file:
