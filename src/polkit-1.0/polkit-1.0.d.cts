...
export function implicit_authorization_from_string(string: string | null): [ /* returnType */ boolean, /* out_implicit_authorization */ ImplicitAuthorization ]
...
export interface Authority extends Gio.AsyncInitable, Gio.Initable {
 ...
 * @class 
 */
export class Authority extends GObject.Object {
...
export module Permission {
    ...
    export interface ConstructorProperties extends Gio.AsyncInitable.ConstructorProperties, Gio.Initable.ConstructorProperties, Gio.Permission.ConstructorProperties {
...
export interface Permission extends Gio.AsyncInitable, Gio.Initable {
...
export module SystemBusName {
    ...
    export interface ConstructorProperties extends Subject.ConstructorProperties, GObject.Object.ConstructorProperties {
...
export interface SystemBusName extends Subject {
 ...
 * @class 
 */
export class SystemBusName extends GObject.Object {
...
export module UnixGroup {
    ...
    export interface ConstructorProperties extends Identity.ConstructorProperties, GObject.Object.ConstructorProperties {
...
export interface UnixGroup extends Identity {
 ...
 * @class 
 */
export class UnixGroup extends GObject.Object {
...
export interface UnixNetgroup extends Identity {
 ...
 * @class 
 */
export class UnixNetgroup extends GObject.Object {
...
export interface UnixProcess extends Subject {
 ...
 * @class 
 */
export class UnixProcess extends GObject.Object {
...
export module UnixSession {
    ...
    export interface ConstructorProperties extends Gio.AsyncInitable.ConstructorProperties, Gio.Initable.ConstructorProperties, Subject.ConstructorProperties, GObject.Object.ConstructorProperties {
...
export interface UnixSession extends Gio.AsyncInitable, Gio.Initable, Subject {
 ...
 * @class 
 */
export class UnixSession extends GObject.Object {
...
export interface UnixUser extends Identity {
 ...
 * @class 
 */
export class UnixUser extends GObject.Object {
...
export interface AuthorizationResultClass {
}
...
export interface IdentityIface {
...
export interface SystemBusNameClass {
}
...
export interface TemporaryAuthorizationClass {
}
...
export interface UnixGroupClass {
}
...
export interface UnixNetgroupClass {
}
...
export interface UnixProcessClass {
}
...
export interface UnixSessionClass {
}
...
export interface UnixUserClass {
}
