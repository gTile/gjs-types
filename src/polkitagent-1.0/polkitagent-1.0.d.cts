 ...
 */
export function register_listener(listener: Listener, subject: Polkit.Subject, object_path: string | null): boolean
...
export module TextListener {
     ...
     */
    export interface TtyAttrsChangedSignalCallback {
